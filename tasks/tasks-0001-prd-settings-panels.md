...
- [x] 2.0 Implement the Admin dashboard Settings tab with username/password update flows and secure current-password validation.
...
- [x] 3.0 Integrate admin billing summary display and Supabase Storage-backed avatar upload with preview/retry handling.
  - [x] 3.1 Fetch billing snapshot data (existing context or new query) and render a read-only card inside the admin settings.
